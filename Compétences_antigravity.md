...
Consultez le [Registre complet des Skills](README.md#full-skill-registry-233233) dans le README principal
...
Consultez notre [CONTRIBUTING.md](CONTRIBUTING.md) pour des instructions étape par étape
...
**R :** Oui ! Consultez la skill `@skill-creator` ou lisez [CONTRIBUTING.md](CONTRIBUTING.md)
...
3. ✅ Lisez [CONTRIBUTING.md](CONTRIBUTING.md) si vous voulez aider
...
**Prêt à aller plus loin ?** Consultez le [README.md](README.md) principal pour la liste complète des skills.
